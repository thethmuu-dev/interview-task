...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { min_to_walk: @station.min_to_walk, name: @station.name, property_id: @station.property_id, railway_name: @station.railway_name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { min_to_walk: @station.min_to_walk, name: @station.name, property_id: @station.property_id, railway_name: @station.railway_name } }
